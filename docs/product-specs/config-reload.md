...
4. validates deprecated settings, every torrent client, and Prowlarr settings
...
An RSS or targeted search run retains one snapshot for its entire execution. An RSS interval
