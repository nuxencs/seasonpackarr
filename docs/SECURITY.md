...
- database created with owner-only Unix permissions; use service-account ACLs on Windows
...
- database and backups: torrent bytes and retained download links can contain tracker credentials
