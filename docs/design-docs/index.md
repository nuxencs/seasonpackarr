...
| `season-pack-lifecycle.md` | End-to-end processing and outcome model from webhook to hardlink | Verified against `cmd/start.go`, `internal/domain/outcome.go`, `internal/http/*`, `internal/notification/*`, `internal/release/*` | 2026-08-10 |
