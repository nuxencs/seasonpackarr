...
| `qbittorrent-import-flow.md` | `/api/import` client import flow, timings, and complete-vs-partial behavior | Verified against `internal/torrentclient/*`, real qBittorrent 5.x and Transmission daemons, Deluge 1.3.15, and Deluge 2.1.2 | 2026-08-12 |
