...
A user with autobrr, a supported torrent client, and TV automation wants season packs to be grabbed without redownloading episodes they already have.
...
5. integration confidence with autobrr and supported torrent clients (qBittorrent, Transmission, Deluge)
