...
const (
	...
	StatusQbitConfigError          StatusCode = 459
...
func (s StatusCode) String() string {
	...
	case StatusAddTorrentError:
		return "could not add torrent to qbittorrent"
	case StatusFindTorrentError:
		return "could not find added torrent in qbittorrent"
	case StatusRecheckTorrentError:
		return "could not recheck torrent in qbittorrent"
	case StatusResumeTorrentError:
		return "could not resume torrent in qbittorrent"
	case StatusQbitConfigError:
		return "invalid qbittorrent import config"
